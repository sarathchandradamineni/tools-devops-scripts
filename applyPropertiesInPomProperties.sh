...
for repo in "${repos[@]}"; do
    ...
    for branch in "${branches[@]}"; do
        ...
        git branch feature/HPSOFT-12372-metadata-for-ncsu-automatic-"$branch"
        git checkout feature/HPSOFT-12372-metadata-for-ncsu-automatic-"$branch"
        ...
        git push --set-upstream origin feature/HPSOFT-12372-metadata-for-ncsu-automatic-"$branch"
    done
done
